            ...
            for j in xrange(i+1):
                ...
                for k in xrange(nbf):
                    for l in xrange(k+1):
                        ...
                        if ij >= kl:
                            if (i == j and k == l):
                                jrdm += factor(i,j,k,l)*rdm2[ijkl(i,j,k,l)]*twoe[ijkl(i,j,k,l)]
                            if (i == k and j == l):
                                krdm += factor(i,j,k,l)*rdm2[ijkl(i,j,k,l)]*twoe[ijkl(i,j,k,l)]
                            #if abs(rdm2[ijkl(i,j,k,l)]) > 1.0e-10:
                                #print "{0:3d}{1:3d}{2:3d}{3:3d} {4:25.14f}".format(
                                    #i, j, k, l, twoe[ijkl(i,j,k,l)])
                            ee += factor(i,j,k,l)*rdm2[ijkl(i,j,k,l)]*twoe[ijkl(i,j,k,l)]
